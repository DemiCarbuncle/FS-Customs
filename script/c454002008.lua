...
function s.target(montype,chkfun)
	return function(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
		...
		if chkc then return chkc:IsControler(tp) and c:IsLocation(LOCATION_GRAVE) and and chkc:IsCanBeSpecialSummoned(e,0,tp,false,false) and cancelcon(Group.FromCards(chkc)) end
